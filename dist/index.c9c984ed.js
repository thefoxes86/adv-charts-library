...
})({"2bKuS":[function(require,module,exports) {
...
var _advert = require("./api/advert");
var _advertDefault = parcelHelpers.interopDefault(_advert);
var _advert2 = require("./api/advert2");
var _advert2Default = parcelHelpers.interopDefault(_advert2);
...
var _header2Default = parcelHelpers.interopDefault(_header2);
var _generatechartsadvTs = require("../src/Generatechartsadv.ts");
...
var _resultados = require("./api/resultados");
var _resultadosDefault = parcelHelpers.interopDefault(_resultados);
var _resultados2 = require("./api/resultados2");
var _resultados2Default = parcelHelpers.interopDefault(_resultados2);
var _resultadosWhituoutStar = require("./api/resultadosWhituoutStar");
var _resultadosWhituoutStarDefault = parcelHelpers.interopDefault(_resultadosWhituoutStar);
window.addEventListener("DOMContentLoaded", ()=>{
    ...
    setTimeout(()=>{
        // result
        chart.init((0, _resultadosDefault.default));
        type2.init((0, _resultadosWhituoutStarDefault.default));
    }, 3000);
    setTimeout(()=>{
        // result
        chart.init((0, _resultados2Default.default));
    }, 5000);
    setTimeout(()=>{
        // result
...
},{"./api/advert":"4FESA","./api/advert2":"fdmO0","./api/home":"eyNb7","./api/gmb":"1xfqy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../src/Generatechartsadv.ts":"7WdTZ","./api/header":"7JNwt","./api/header2":"9LjPJ","./api/header-reload":"hMg6y","./api/headerSummary":"97ey7","./api/gmb2":"hUuRo","./api/headerSummary2":"lN0fn","./api/headerSummary3":"8XI9K","./api/resultados":"dbsEP","./api/resultados2":"k6GmO","./api/resultadosWhituoutStar":"8TSBt"}],"4FESA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"fdmO0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const advert = {
    result: "ok",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eyNb7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const home = {
    result: "ok",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1xfqy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const gmb = {
    result: "ok",
        ...
        cards.forEach((el, index)=>{
            ...
            if (this.objAdv.format === "type3") {
                ...
                if (checkStarsReviews) {
                    ...
                    let valuePerc1 = this.objAdv.percValues[index];
                    this.previousValue = this.previousValue === null ? this.objAdv.percValues[index] : this.previousValue;
                    ...
                    numberReviews.start();
                    console.log("test", this.bullet, valuePerc1);
                    if (this.previousValue > valuePerc1) {
                        (0, _animateBulletsDefault.default)(this.bullet, valuePerc1, this.previousValue);
                        this.previousValue = null;
                    } else (0, _animateBulletsDefault.default)(this.bullet, valuePerc1, this.previousValue);
                }
            }
            this.contentRow = [
        ...
        contentRow.forEach((row, indexRow)=>{
            ...
            if (this.objAdv.format === "type2") {
                ...
                circleResult.forEach((circle)=>{
                    ...
                    // @ts-ignore
                    circle.style["stroke-dasharray"] = `${this.objAdv.percValues[indexRow]} 100`;
                });
            }
            // ROW TYPE 3
            if (this.objAdv.format === "type3") {
                indexRowVar = this.isReviewPresent ? indexRow + 2 : indexRow;
                0, _animateBulletsDefault.default;
            }
            ...
            if (previousValue?.innerHTML !== `${this.objAdv.realValues[indexRowVar]}${this.objAdv.valueLabels[indexRowVar]}`) {
                if (this.update) {
                    let updateCount = this.percValueText.find((element)=>element.id === `${this.objAdv.type}-${indexRowVar}`);
                    updateCount?.data?.update(this.objAdv.realValues[indexRowVar]);
                } else {
                    let initCountJs = new (0, _countupJs.CountUp)(`perc-value-${this.objAdv.type}-${index}-row-${indexRow}`, this.objAdv.realValues[indexRowVar], {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9LjPJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const header2 = {
    result: "ok",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hMg6y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const headerReload = {
    result: "ok",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dbsEP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const resultados = {
    result: "ok",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k6GmO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const resultados2 = {
    result: "ok",
...
exports.default = resultados2;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8TSBt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const resultadosWhithoutStar = {
    result: "ok",
    valueLabels: [
        "",
        "",
    ...
    type: "resultadosWhithoutStar",
    format: "type3"
};
exports.default = resultadosWhithoutStar;
