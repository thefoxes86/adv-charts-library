...
var _generatechartsadv = require("../src/Generatechartsadv");
...
},{"./api/advert":"4FESA","./api/advert2":"fdmO0","./api/home":"eyNb7","./api/gmb":"1xfqy","./api/type4":"97CjY","../src/Generatechartsadv":"fywa4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4FESA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"97CjY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const type4 = {
    result: "ok",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fywa4":[function(require,module,exports) {
"use strict";
// Version 1.0.4
...
var Generatechartsadv = /** @class */ function() {
    ...
    Generatechartsadv.prototype.init = function(obj) {
        this.objAdv = obj;
        this.typedCard = this.chartCard.filter(function(elem) {
            return elem.dataset["type"] === obj.type;
        });
    ...
    Generatechartsadv.prototype.iterateMainElement = function(cards) {
        ...
        cards.forEach(function(el, index) {
            ...
            if ((previousPercValue === null || previousPercValue === void 0 ? void 0 : previousPercValue.innerHTML) !== value) {
                ...
                if (_this.update) _this.percValue.update(_this.objAdv.realValues[_this.objAdv.realValues.length - 1]);
                else _this.percValue.start();
            }
    ...
    Generatechartsadv.prototype.iterateRow = function(contentRow, index) {
        ...
        contentRow.forEach(function(row, indexRow) {
            ...
            if ((previousValue === null || previousValue === void 0 ? void 0 : previousValue.innerHTML) !== "".concat(_this.objAdv.realValues[indexRow]).concat(_this.objAdv.valueLabels[indexRow])) {
                ...
                if (_this.update) _this.percValueText.update(_this.objAdv.realValues[indexRow]);
                else _this.percValueText.start();
            }
