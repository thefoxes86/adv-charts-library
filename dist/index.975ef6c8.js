...
var generateCharts_1 = require("./generateCharts");
window.addEventListener("DOMContentLoaded", function() {
    setTimeout(function() {
        (0, generateCharts_1["default"])(advert_1["default"]);
    }, 1000);
    setTimeout(function() {
        (0, generateCharts_1["default"])(home_1["default"]);
    }, 2000);
    setTimeout(function() {
        (0, generateCharts_1["default"])(gmb_1["default"]);
    }, 3000);
});

},{"./api/advert":"b9o7f","./api/home":"i0KUi","./api/gmb":"01RjA","./generateCharts":"7LoN0"}],"b9o7f":[function(require,module,exports) {
...
},{}],"i0KUi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const home = [
    {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"01RjA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const gmb = [
    {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7LoN0":[function(require,module,exports) {
"use strict";
...
var generateCharts = function(array) {
    if ((array === null || array === void 0 ? void 0 : array.length) > 0) {
        var chartCard = __spreadArray([], document.querySelectorAll(".chart-card"), true);
        var typedCard_1 = chartCard.filter(function(elem) {
            return elem.dataset["type"] === array[0].type;
        });
        console.log("element", typedCard_1);
        setTimeout(function() {
            typedCard_1.forEach(function(el, index) {
                console.log("Type", "".concat(array[index].type, " - ").concat(index));
                var header = el.querySelector(".chart-card__header");
                var circle = el.querySelector(".circle-chart__circle");
                //   let text = el.querySelector('.circle-chart__percent')
                header.classList.add(array[index].valueColors[array[index].valueColors.length - 1]);
                circle.style["stroke-dasharray"] = "".concat(array[index].percValues[array[index].percValues.length - 1], " 100");
                var percValue = new countup_js_1.CountUp("mainValuePerc-".concat(array[index].type, "-").concat(index), array[index].realValues[array[index].realValues.length - 1], {
                    suffix: array[index].valueLabels[array[index].valueLabels.length - 1]
                });
                percValue.start();
                var contentRow = __spreadArray([], el.querySelectorAll(".content__row"), true);
                contentRow.forEach(function(row, indexRow) {
                    var barContent = row.querySelector(".bar__content");
                    barContent.classList.add(array[index].valueColors[indexRow]);
                    barContent.style.width = "".concat(array[index].percValues[indexRow], "%");
                    var percValueText = new countup_js_1.CountUp("perc-value-".concat(array[index].type, "-").concat(index, "-row-").concat(indexRow), array[index].realValues[indexRow], {
                        suffix: array[index].valueLabels[indexRow]
                    });
                    percValueText.start();
                    var textValue = document.getElementById("perc-value-".concat(array[index].type, "-").concat(index, "-row-").concat(indexRow));
                    textValue.classList.add("".concat(array[index].valueColors[indexRow], "-text"));
                });
...
exports["default"] = generateCharts;

},{"countup.js":"dyWzm"}],"dyWzm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequired657")
