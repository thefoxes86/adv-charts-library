...
window.addEventListener("DOMContentLoaded", ()=>{
    ...
    setTimeout(()=>{
        // result
        chartAdvert.reload((0, _advert2Default.default));
    }, 4000);
    setTimeout(()=>{
...
},{"./api/advert":"b9o7f","./api/advert2":"5rsb5","./api/home":"i0KUi","./api/gmb":"01RjA","./Generatechartsadv":"fywa4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b9o7f":[function(require,module,exports) {
"use strict";
...
},{}],"01RjA":[function(require,module,exports) {
"use strict";
exports.__esModule = true;
var gmb = [
    {
...
},{}],"fywa4":[function(require,module,exports) {
"use strict";
// Version 1.0.4
...
globalThis.Generatechartsadv = /** @class */ function() {
    function Generatechartsadv1(className) {
        this.chartCard = __spreadArray([], document.querySelectorAll(".".concat(className)), true);
    }
    Generatechartsadv1.prototype.init = function(array) {
        this.arrayAdv = array;
        this.typedCard = this.chartCard.filter(function(elem) {
            return elem.dataset["type"] === array.type;
        });
        this.iterateMainElement(this.typedCard);
    };
    Generatechartsadv1.prototype.iterateMainElement = function(cards) {
        var _this = this;
    ...
    Generatechartsadv1.prototype.iterateRow = function(contentRow, index) {
        var _this = this;
